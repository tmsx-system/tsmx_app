    ...
    return RefreshIndicator(
      ...
      child: NotificationListener<ScrollNotification>(
        ...
        child: CustomScrollView(
          ...
          slivers: [
            SliverPadding(
              padding: logisticsPagePaddingOf(context).copyWith(bottom: 0),
            ...
            if (rows.isEmpty && !appState.isDeliveryNotesLoading)
              SliverPadding(
                padding: logisticsPagePaddingOf(context).copyWith(top: 0),
              ...
              SliverPadding(
                ...
                sliver: SliverList.builder(
                  ...
                  itemBuilder: (context, index) => _deliveryCard(rows[index]),
                ),
              ),
            if (appState.hasMoreDeliveryNotes ||
                appState.isMoreDeliveryNotesLoading)
              SliverPadding(
                padding: logisticsPagePaddingOf(context).copyWith(top: 8),
