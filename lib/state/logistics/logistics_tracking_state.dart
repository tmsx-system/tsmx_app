...
class LogisticsTrackingState extends AppStateProxyNotifier
    with LogisticsDeliveryNoteQueryMixin {
  LogisticsTrackingState({required super.appState}) {
  ...
  Future<List<DeliveryActivityLog>> fetchDeliveryActivityLogs(String name) {
    return appState.fetchDeliveryActivityLogs(name);
  }
  ...
  Future<void> recordDeliveryActivity({
    ...
    return appState.recordDeliveryActivity(
